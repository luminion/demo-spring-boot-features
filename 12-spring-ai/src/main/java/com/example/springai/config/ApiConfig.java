...
public class ApiConfig {
    ...
    @Bean(AiConst.BAIYUNSHAN_API)
    public OpenAiApi baiyunshanApi() {
        return OpenAiApi.builder()
                .baseUrl(AiConst.BAIYUNSHAN_URL)
                .apiKey(System.getenv("BAIYUNSHAN_API_KEY"))
                .build();
    }
