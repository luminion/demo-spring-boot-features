package com.example.springai.t20rag.r02module;

import com.example.springai.rag.SimpleDocumentPostProcessor;
...
//                .context(Map.of(VectorStoreDocumentRetriever.FILTER_EXPRESSION, "author == 'luminion'")) // 过滤表达式
                .build();
