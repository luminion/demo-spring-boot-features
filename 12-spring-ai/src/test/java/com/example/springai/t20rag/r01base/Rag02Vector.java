package com.example.springai.t20rag.r01base;
 ...
 * <p>
 * 也可以使用手动配置, 配置多个向量数据库 : {@link com.example.springai.config.VectorStoreConfig#vectorStore(JdbcTemplate, EmbeddingModel)}
 * <p>
